...
public class HelloRoute extends RouteBuilder {
    ...
    public void configure() {
        ...
        String greetingStr = String.format(greeterMessageFormat, greeterPrefixEnv) + " 333";

        rest().get("/hello").id("restHello").to("direct:hello").bindingMode(RestBindingMode.json);

        from("direct:hello").id("helloRoute")
                .log(LoggingLevel.INFO, "3 env: " + greeterPrefixEnv)
                .log(LoggingLevel.INFO, "3 file: " + greeterPrefix)
